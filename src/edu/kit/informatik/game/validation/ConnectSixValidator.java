...
public class ConnectSixValidator {
    ...
    // Command Validation
    public static CommandValidation validateCommand(ICommand command, CommandSignature commandSignature) throws ValidationException {
        return new CommandValidation(command, commandSignature);
    }
}