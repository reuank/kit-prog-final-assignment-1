...
import edu.kit.informatik.interfaces.IList;
...
public class List<T> implements IList<T> {
     ...
     */
    public List() {
        this.head = null; // Leere Liste erzeugen
    }
    ...
    public void add(T item) {
        // Wenn Liste leer: Ersten Eintrag erstellen!
        if (this.head == null) {
        ...
        while (i.next != null) { // Gehe zum Ende der Liste
            i = i.next;
        }
     ...
     * @param needle The element that should be searched
     * @return Returns true it element is in the list
     */
